...
  const [transactionStatus, setTransactionStatus] = useState(null);  const handleAmountChange = (e) => {
...
    <h2>Amount to be paid: <span>$5,000</span></h2>
    <p>Thank you for choosing PropWise. Receipt and complete property documentation would be available after a successful payment and transaction report is successful.</p>
...
    </div>
  </div>
);const PaymentDetails = ({ amount, onAmountChange, onProceed, insufficientBalance, walletBalance, onTopUp }) => (
...
    />
    {insufficientBalance && <p className="error">Insufficient Balance? <a href="/topup" onClick={onTopUp}>Top Up Wallet</a></p>}
